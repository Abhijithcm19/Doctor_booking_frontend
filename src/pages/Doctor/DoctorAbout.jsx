...
const DoctorAbout = ({doctorDetails}) => {
    if (!doctorDetails) {
        return <Loading />; // Or any placeholder/loading component while fetching data
      }

    const { name, description, education, experience, about } = doctorDetails
  return (
    <div>
        <div>
