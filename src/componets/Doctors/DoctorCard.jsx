...
const DoctorCard = ({doctor}) => {
   ...
   const {name,_id, avgRating, totalRating, photo, specialization, totalPatients, hospital} = doctor 
console.log("all docc", doctor)
  return (
    <div className='p-3 lg:p-5'>
        <div >
        <img src={photo} className="w-full h-auto max-w-full max-h-[150px]" alt="" />
      </div>

        <h2 className='text-[18px] leading-[30px] lg:text-[26px] lg:leading-9 text-headingColor front-[700] mt-3 lg:mt-5'>
            {name}
